...
### Compilando
 ...
 - Terminal:
       ...
       gcc -O2 -pedantic-errors -Wall -Werror utils.c client.c client-app.c -o client -lpthread

       gcc -O2 -pedantic-errors -Wall -Werror utils.c server.c server-app.c -o server -lpthread
