...
void iniciar_chat(Cliente *cliente)
{
        ...
        {
                pthread_create(&client_send_thread, NULL, func_thread_send_cliente, (void *)cliente);
                pthread_create(&client_recv_thread, NULL, func_thread_recv_cliente, (void *)cliente);
